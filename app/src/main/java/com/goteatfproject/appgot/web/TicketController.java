...
//import com.goteatfproject.appgot.service.TicketService;
...
//  ServletContext sc;
//
//  public TicketController(TicketService ticketService, ServletContext sc) {
...
//  @GetMapping("list")
//  @ResponseBody
//  public ModelAndView selectEventList(Ticket ticket, Criteria cri) throws Exception {
//
...
//
//    List<Map<String, Object>> list = ticketService.selectTicketList(cri);
...
//  // 파티 리스트 게시물 등록
//  @GetMapping("form")
//  public String ticketFrom() throws Exception {
//    return "ticket/ticketAdd";
//  }
//
//  // 파티 리스트 게시물 등록 post
//  @PostMapping("add")
//  public String ticketAdd(Ticket ticket, HttpSession session,
